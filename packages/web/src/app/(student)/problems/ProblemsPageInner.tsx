      ...
      <div className="p-4">
        <div className="flex items-start gap-2">
          <div className="min-w-0 flex-1">
            <h3 className="truncate" style={{ fontSize: '15px', fontWeight: 700, color: '#16181D' }}>
              {stage.title}
            </h3>
    ...
    <div className="mx-auto flex w-full max-w-[1240px] flex-col gap-6">
      {stageId ? (
          ...
          <div className="relative flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <h1 style={{ fontSize: '25px', fontWeight: 800, color: '#16181D', letterSpacing: '-0.02em' }}>
                  {stage?.title}
                </h1>
            ...
            <div className="flex shrink-0 items-center gap-4 rounded-2xl bg-card/85 px-5 py-3 shadow-sm backdrop-blur">
              <div>
                ...
                <p className="mt-0.5" style={{ fontSize: '18px', fontWeight: 800, color: '#1B64DA' }}>
                  {solvedCount}<span style={{ fontSize: '12px', fontWeight: 500, color: '#8A8F98' }}> / {allStageProblems.length}</span>
                </p>
              </div>
        ...
        <header className="flex flex-col gap-2">
          ...
          <h1 style={{ fontSize: '26px', fontWeight: 800, color: '#16181D', letterSpacing: '-0.025em' }}>
            어떤 단계부터 시작할까요?
          </h1>
      ...
      {drafts.length > 0 && (
        <section className="overflow-hidden rounded-2xl bg-card" style={{ border: '1px solid #BFDBFE' }}>
          ...
          >
            ...
            <ChevronDown size={16} className={`text-[#8A8F98] transition-transform ${draftsOpen ? 'rotate-180' : ''}`} />
          </button>
          {draftsOpen && (
                ...
                <div className="mb-4 flex items-end justify-between gap-4">
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <h2 style={{ fontSize: '19px', fontWeight: 800, color: '#16181D' }}>{subjectItem.title}</h2>
                    </div>
                    {subjectItem.description && (
                      <p className="mt-1.5" style={{ fontSize: '13px', color: '#8A8F98' }}>{subjectItem.description}</p>
                    )}
                  </div>
                  <span className="shrink-0" style={{ fontSize: '12px', color: '#8A8F98' }}>{subjectItem.stages.length}개 단계</span>
                </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        {chapter.description && (
                          <p className="mt-0.5 truncate" style={{ fontSize: '12px', color: '#8A8F98' }}>{chapter.description}</p>
                        )}
                      </div>
                            ...
                            {chapter.problems.map((problem) => {
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <div className="min-w-0 flex-1">
                                    <p className="truncate transition-colors group-hover:text-primary" style={{ fontSize: '14px', fontWeight: 600, color: '#16181D' }}>
                                      {problem.title}
                                    </p>
