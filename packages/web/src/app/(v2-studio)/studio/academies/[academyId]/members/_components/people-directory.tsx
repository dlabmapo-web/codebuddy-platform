...
export function PeopleDirectory({
  ...
  const columns = React.useMemo<ColumnDef<PeopleRow>[]>(
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <Link
            ...
            href={`/studio/academies/${academyId}/members/${row.original.membershipId}/profile`}
          >
            {/*
    ...
    [academyId, i18n.language, isSelected, mutations, pageSelected, rows, t, toggleRow],
  );
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-44">
          <DropdownMenuItem asChild>
            <Link
              href={`/studio/academies/${academyId}/members/${membershipId}/profile`}
            >
