    ...
    <main className="min-h-screen w-full bg-canvas lg:grid lg:grid-cols-[1.05fr_1fr]">
      ...
      <aside className="relative hidden overflow-hidden bg-brand px-14 py-14 text-white lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative">
          <p className="text-[13px] font-medium text-white/75">{t('panel.eyebrow')}</p>
        ...
        <p className="relative text-[12px] text-white/50">{t('common:brand.copyright')}</p>
      </aside>
      ...
      <section className="flex min-h-screen flex-col bg-white px-6 py-9 sm:px-10 lg:px-16 lg:py-12">
        <header className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Someone who cannot read this page never reaches the sidebar
                switcher, so the auth screens carry their own. */}
